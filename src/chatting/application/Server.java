...
public class Server implements ActionListener{ // server is a class
    ...
    Server(){
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/1.png")); // to choose image from directory
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            dout.writeUTF(out);           //to send text message
    ...
    public static void main(String []args){
        new Server();  // make annonomous object of  class;
        
        try{
        ServerSocket skt = new ServerSocket(6001);   // for creating server 6001 is a port number
        while(true){    // for infinetly accept message
        Socket s = skt.accept();        // message cominfg from client accept by this line
